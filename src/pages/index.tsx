  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#2e026d] to-[#15162c]">
        <div className="bg-white drop-shadow-lg">
          ...
          <div className="p-2 border border-gray-300">
            <div className="flex flex-1">
              ...
              {/* <button onClick={() => {setErrorMsg("");setWin(false)}} className="group hover:bg-gray-200 active:bg-gray-300">
                <svg className="h-8 w-8 m-2 fill-current text-gray-500 group-hover:text-gray-700" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        {win && (
          <Confetti width={width} height={height} recycle={false} initialVelocityY={{min: -2, max: 5}}/>
        )}
      </main>
    </>
  );
