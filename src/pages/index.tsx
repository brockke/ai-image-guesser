        ...
        <div className="bg-white drop-shadow-lg">
          ...
          <div className="p-2 outline outline-1 outline-gray-300">
            <div className="flex flex-1 outline-4">
              <button className="group hover:bg-gray-200">
                <svg className="h-8 w-8 m-2 fill-current text-gray-500 group-hover:text-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
